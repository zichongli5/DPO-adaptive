...
from trl import PreTrainedModelWrapper, create_reference_model
    ...
    def dpo_loss(
        ...
        ################################################################################################
            ...
            for i in range(self.n_tau_iters):
                grad_tau = -torch.log(2*torch.sigmoid(logits_detach/tau)+1e-6) + (1-torch.sigmoid(logits_detach/tau))*(logits_detach/tau) + self.rho
